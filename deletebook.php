...
<body bgcolor="#f4f4f4">
	<table width="100%" border="0" align="center">
		...
		<tr>
			...
			<td><?php echo $row_book['booktype'];?><input name="BookID" type="hidden" id="BookID" value="<?php echo $row_book['bookid']?>"/></td>
			<td><a href="delete.php?BookID=<?php echo $row_book['bookid'] ?>" title="delete.php?BookID=<?php echo $row_book['bookid'] ?>">删除</a>&nbsp; 
                            <a href="edit.php?BookID=<?php echo $row_book['bookid'] ?>" title="edit.php?BookID=<?php echo $row_book['bookid'] ?>">编辑</a></td> 
			</tr>
